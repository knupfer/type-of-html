...
main = mainWith $ do
  ...
  f "listOfAttributes"     (\x -> [ClassA x, ClassA x]) ()       [    712 ,     0 ,       0 ,     0 ,    0 ,      8 ]
  ...
  f "AttrShort"            M.attrShort ()                        [   5560 ,  -400 ,   -2360 ,     0 ,    0 ,   2208 ]
  f "pageA"                M.pageA ()                            [   5864 ,  -624 ,   -2704 ,     0 ,    0 ,    632 ]
  f "AttrLong"             M.attrLong ()                         [   6448 ,  -384 ,       0 ,  -864 ,    0 ,     64 ]
  f "Big table"            M.table (50,10)                       [ 120072 ,     0 ,    1600 , -8096 , 7952 , -15288 ]
  f "hackage upload"       EX.hackageUpload ()                   [ 851016 , -21952, -641784 , -4024 ,    0 , 166480 ]
